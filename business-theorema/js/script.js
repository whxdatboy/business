...
/***/ "./_src/js/components/animation-delay.js":
/*!***********************************************!*\
  !*** ./_src/js/components/animation-delay.js ***!
  \***********************************************/
/***/ (() => {
...
var lastInterval = -1;
var recallBtn = document.querySelector('.main__recall'),
...
/***/ "./_src/js/components/animation-restart.js":
/*!*************************************************!*\
  !*** ./_src/js/components/animation-restart.js ***!
  \*************************************************/
...
/* harmony export */   "restartAnimation": () => (/* binding */ restartAnimation)
/* harmony export */ });
function restartAnimation() {
  var element = document.querySelector('.progress-line');
...
/***/ "./_src/js/components/localStorage.js":
/*!********************************************!*\
  !*** ./_src/js/components/localStorage.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener('DOMContentLoaded', function () {
  var inputSearch = document.querySelector('input[type="search"]'),
      btnDelete = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.btn-delete');
...
/***/ "./_src/js/components/slide-count.js":
/*!*******************************************!*\
  !*** ./_src/js/components/slide-count.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "countChange": () => (/* binding */ countChange)
/* harmony export */ });
function countMax() {
  var slides = document.querySelectorAll('.main-slider__left:not(.swiper-slide-duplicate)');
  document.querySelector('.pagination-max').innerText = "0".concat(slides.length);
}
function countChange() {
  var activeSlide = document.querySelector('.swiper-slide-active').getAttribute('data-swiper-slide-index'),
      index = +activeSlide + 1;
  document.querySelector('.pagination-count').innerText = "0".concat(index);
}

/***/ }),

/***/ "./_src/js/components/slideChange.js":
/*!*******************************************!*\
  !*** ./_src/js/components/slideChange.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./_src/js/components/slideLoaded.js":
/*!*******************************************!*\
  !*** ./_src/js/components/slideLoaded.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setActiveBullet": () => (/* binding */ setActiveBullet)
/* harmony export */ });
function setActiveBullet() {
  var slideTheme = localStorage.getItem('themeColor'),
      classTheme = 'theme-';
...
/***/ "./_src/js/components/svg-animation.js":
/*!*********************************************!*\
  !*** ./_src/js/components/svg-animation.js ***!
  \*********************************************/
/***/ (() => {

var linksWrap = document.querySelector('.svg-nav'),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vendor/modal */ "./_src/js/vendor/modal.js");
/* harmony import */ var _components_localStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/localStorage */ "./_src/js/components/localStorage.js");
/* harmony import */ var _vendor_swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/swiper */ "./_src/js/vendor/swiper.js");
...
/* harmony import */ var _components_svg_animation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/svg-animation */ "./_src/js/components/svg-animation.js");
/* harmony import */ var _components_svg_animation__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_components_svg_animation__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _components_animation_delay__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/animation-delay */ "./_src/js/components/animation-delay.js");
/* harmony import */ var _components_animation_delay__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_components_animation_delay__WEBPACK_IMPORTED_MODULE_8__);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var modalsItem = $('.modal-menu__item');
  modalsItem.each(function () {
    $(this).on('click', function (e) {
      e.preventDefault();
      var $desc = $(this).find('.modal-menu__desc');
      $desc.toggleClass('desc-active');
    });
  });
  var btnCloseModal = $('.modal-close');
  btnCloseModal.each(function () {
    $(this).click(function (e) {
      e.preventDefault();
      $('.modal').removeClass('is-active'), $(this).closest('.modal-container').removeClass('is-active');
    });
  });
  ...
  (0,_vendor_slider_modal__WEBPACK_IMPORTED_MODULE_3__.openModalSliders)();
  var btnBack = document.querySelector('.nav-back');
  btnBack.addEventListener('click', function (e) {
    e.preventDefault();
    (0,_vendor_slider_close__WEBPACK_IMPORTED_MODULE_4__.closeSliderModal)();
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./_src/js/vendor/utils.js");
...
var Modal = /*#__PURE__*/function () {
  function Modal() {
    ...
    this.modalBody = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal');
  ...
  _createClass(Modal, [{
    key: "isOtherOpen",
    value: function isOtherOpen() {
      return jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.modalSelector).filter(".".concat(this.activeClass)).length;
    }
  }, {
    key: "open",
    value: function open(id) {
      var $modal = jquery__WEBPACK_IMPORTED_MODULE_0___default()("[data-modal=".concat(id, "]"));
      console.log($modal); // lockScroll();
    ...
    key: "openWithAjax",
    value: function openWithAjax(id, params) {
      var _this = this;

      var isModalExist = jquery__WEBPACK_IMPORTED_MODULE_0___default()("[data-modal=".concat(id, "]")).length;
      ...
      var ajaxUrl = isLocalhost ? "/ajax/".concat(id, ".html") : '/local/ajax/';
      var ajaxMethod = isLocalhost ? "get" : 'post';
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        ...
        success: function success(data) {
          var dataHtml = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.createElement)(data.HTML);
          document.body.insertAdjacentElement('beforeend', dataHtml);

          _this.onModalLoaded(dataHtml);

          _this.open(id);

          if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("[data-modal=".concat(id, "]")).find('[data-input-phone]').length) {
    ...
    value: function toggle(id) {
      var $modal = jquery__WEBPACK_IMPORTED_MODULE_0___default()("[data-modal=".concat(id, "]"));
      var isActive = $modal.hasClass(this.activeClass);
    ...
    value: function showLoader() {
      var $loader = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".modal-loader");

      if (!$loader.length) {
        $loader = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div class=\"modal-loader\" />");
    ...
    value: function showError() {
      var $errorModal = jquery__WEBPACK_IMPORTED_MODULE_0___default()("[data-modal=\"modal-error\"]");

      if (!$errorModal.length) {
        $errorModal = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div class=\"modal\" data-modal=\"modal-error\"><div class=\"modal__error\">\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430</div></div>");
    ...
    key: "onModalLoaded",
    value: function onModalLoaded(dataHtml) {}
  }]);
...
/***/ "./_src/js/vendor/slider-close.js":
/*!****************************************!*\
  !*** ./_src/js/vendor/slider-close.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "closeSliderModal": () => (/* binding */ closeSliderModal)
/* harmony export */ });
function closeSliderModal() {
  var modalSliderLeft = document.querySelector('.main-slider__modal-services.is-active'),
...
/***/ "./_src/js/vendor/slider-modal.js":
/*!****************************************!*\
  !*** ./_src/js/vendor/slider-modal.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "openModalSliders": () => (/* binding */ openModalSliders)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);

function openModalSliders() {
  var btnModalSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.open-modal-slider'),
      activeClass = 'is-active',
      btnBack = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-back');
  btnModalSlider.each(function () {
    var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    $this.on("click", function (e) {
      e.preventDefault();
      var $modalSlide = $this.closest('.main-slider__left').find('.main-slider__modal-services'),
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() < 768) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-footer').css('display', 'none');
      }
    });
  });
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_slideLoaded__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/slideLoaded */ "./_src/js/components/slideLoaded.js");
/* harmony import */ var _components_slideChange__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/slideChange */ "./_src/js/components/slideChange.js");
/* harmony import */ var _components_slide_count__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/slide-count */ "./_src/js/components/slide-count.js");
/* harmony import */ var _components_animation_restart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/animation-restart */ "./_src/js/components/animation-restart.js");
/* harmony import */ var _components_localStorage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/localStorage */ "./_src/js/components/localStorage.js");
...
var swiperText = new Swiper('.main-slider__swiper-text', {
  ...
  on: {
    beforeInit: function beforeInit() {
      (0,_components_localStorage__WEBPACK_IMPORTED_MODULE_4__.getThemeColor)();
    },
    init: function init() {
      (0,_components_slideLoaded__WEBPACK_IMPORTED_MODULE_0__.setActiveBullet)();
      (0,_components_slide_count__WEBPACK_IMPORTED_MODULE_2__.countMax)();
    },
    slideChangeTransitionEnd: function slideChangeTransitionEnd() {
      (0,_components_slide_count__WEBPACK_IMPORTED_MODULE_2__.countChange)();
    },
    slideChangeTransitionStart: function slideChangeTransitionStart() {
      (0,_components_slideChange__WEBPACK_IMPORTED_MODULE_1__.themeChange)();
...
/* harmony export */   "animateEasing": () => (/* binding */ animateEasing)
/* harmony export */ });
...
var animateEasing = function animateEasing(render, duration, easing, endAnimation) {
...
/******/ 	__webpack_require__("./_src/js/script.js");
...
/******/ 	__webpack_require__("./_src/js/vendor/swiper.js");
/******/ 	__webpack_require__("./_src/js/vendor/utils.js");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./_src/js/components/svg-animation.js");
/******/ 	
/******/ })()
;
